...
def load_datasets(dataset_path) -> list[str]:
...
def tokenize_and_batch(text: list[str], batch_size: int = 16) -> Iterator[list[str]]:
...
def compute_means(text: list[str], batch_size: int = 16) -> list[torch.Tensor]:
...
def calculate_steering_vector(text_a, text_b, batch_size=16) -> list[torch.Tensor]:
